...
using MeetingWebsite.Areas.Default.Girls.ViewModels;
...
namespace MeetingWebsite.Areas.Default.Girls.Controllers
{
    ...
    public class GirlsController : ControllerBase
    {
        ...
        public GirlsController(EFDbContext context,
        ...
        [HttpPost("girls")]
        public async Task<IActionResult> Girls([FromBody]GirlsViewModels filter)//model
        {
            ...
            var GenderId = await _context.Gender.Where(x => x.Type == "Woman").SingleOrDefaultAsync();
            var a = (DateTime.Now.Year * 100 + DateTime.Now.Month) * 100 + DateTime.Now.Day;
            GetListGirlsModel result = new GetListGirlsModel();
            ...
            List<GetGirlsModel> girls = new List<GetGirlsModel>();
